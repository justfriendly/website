// .wrangler/tmp/bundle-qgPv0m/checked-fetch.js
...
// .wrangler/tmp/pages-sf2U1A/bundledWorker-0.6407919683309384.mjs
...
async function K(e) {
  ...
  try {
    ...
    switch (e.method) {
      case "GET": {
        let i = W(e, fe), r = await s.get(n, { softTags: i });
      ...
      case "POST": {
        let i = await e.json();
        return i.data.tags === void 0 && (i.tags ??= W(e, pe) ?? []), await s.set(n, i), new Response(null, { status: 200 });
      }
      default:
...
// .wrangler/tmp/pages-sf2U1A/slqbl3zg4sb.js
...
// .wrangler/tmp/bundle-qgPv0m/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-qgPv0m/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=slqbl3zg4sb.js.map
